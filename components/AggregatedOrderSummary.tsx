...
const AggregatedOrderSummary: React.FC<AggregatedOrderSummaryProps> = ({ aggregatedItems, selectedDate, onDateChange }) => {
  ...
  return (
    <section aria-labelledby={titleId} className="bg-white p-6 md:p-8 rounded-lg shadow-lg border border-neutral-200">
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center mb-6 gap-4">
        <div>
          <h2 id={titleId} className="text-xl font-semibold text-black mb-1">
            Общий сводный заказ на:
          </h2>
          <Input
